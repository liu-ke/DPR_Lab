...
normal_set=training_set(training_set(:,6)==0);  %seperate normal data and cancer data
...
test_result(MD1<MD2)=[test_set(MD1<MD2),0];
test_result(MD1>=MD2)=[test_set(MD1>=MD2),1];
